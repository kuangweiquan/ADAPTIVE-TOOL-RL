...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    +debug=True \
    +vs_debug=True \
    data.train_files=[${PYVISION_DATASET_TRAIN_0},${PYVISION_DATASET_TRAIN_1},${PYVISION_DATASET_TRAIN_2},${PYVISION_DATASET_TRAIN_3}] \
    ...
    +trainer.rollout_data_dir=/mnt/petrelfs/zhaoshitian/vis_tool_train/rollouts/3 \
